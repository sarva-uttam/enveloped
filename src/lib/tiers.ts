...
export const TIERS: Tier[] = [
  ...
  },
  {
    ...
    description:
      "Everything in Silver, plus full 2D scroll animation, background music, and wording personalized to your story.",
    highlights: [
...
export const TIER_FEATURE_MATRIX: TierFeature[] = [
  ...
  { label: "Personalized wording", includedFrom: "gold" },
